...
export const PRODUCTS = [
  ...
  },
  {
    ...
    longDesc:
      'A 20mg Retatrutide formulation supplied in a pre-filled research device, provided exclusively for controlled laboratory R&D applications. Sealed for compound stability, formulation studies and delivery-mechanism evaluation.',
    price: 100,
    currency: 'USD',
    accent: '#7A8F87',
    tint: '#EAF0EC',
  ...
  },
  {
    ...
    longDesc:
      'NAD+ (Nicotinamide Adenine Dinucleotide) research formulation supplied as two pre-filled 500mg pens (1,000mg total) for laboratory analysis and in vitro study only.',
    price: 140,
    currency: 'USD',
    accent: '#7A6FA8',
    tint: '#ECE9F3',
